...
![Version: 3.203.1](https://img.shields.io/badge/Version-3.203.1-informational?style=flat-square) ![AppVersion: 7](https://img.shields.io/badge/AppVersion-7-informational?style=flat-square)
...
| datadog.logs.dd_ssl_enable | string | `nil` | Override whether the Agent uses SSL when forwarding logs to the configured logs intake endpoint |
